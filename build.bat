...
SET files=assets.py config.py gui.py save_file.py starcheat.py
SET templates=ItemEdit.ui Blueprints.ui MainWindow.ui ItemBrowser.ui Options.ui OpenPlayer.ui
